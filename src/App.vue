<template>
  <div class="content">
    <div v-if="selectedMonth">
      ...
      <div style="height: 30px">
        <p
          style="
            ...
            font-size: 20px;
          "
          onmouseover="this.style.fontSize='30px'"
      ...
      >
        <el-text
          style="margin-left: 10px; font-size: 20px; transition: font-size 0.3s"
          tag="b"
          type="info"
          @mouseover="$event.target.style.fontSize = '24px'"
          @mouseout="$event.target.style.fontSize = '20px'"
        >
          {{ monthOfSelected }}
        </el-text>
        <div style="margin-left: auto; display: flex">
          <div
            @click="backToSelectMonth()"
            style="
              height: 45px;
              width: 125px;
              margin-left: 10px;
          ...
          >
            <span style="font-weight: 500; font-size: 15px; text-align: center"
              >月分選択へ</span
            >
          </div>
          <div
    ...
    <div v-if="!selectedMonth">
      ...
      <div style="margin-top: 100%; display: flex; align-items: center">
        ...
        <el-date-picker
          ...
          v-model="monthOfSelected"
          type="month"
          value-format="YYYY年MM月"
          size="large"
          placeholder="月分選択ください"
        />
        <div
          @click="toKinndai()"
          style="
...
// 選択した月に関するHooks
const { selectedMonth, monthOfSelected, toKinndai, backToSelectMonth } =
  useSelectedMonth();
